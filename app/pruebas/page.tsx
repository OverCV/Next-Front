...
// Componente para probar vista del embajador
function ComponenteVistaEmbajador() {
    const router = useRouter()

    // Estados para los parámetros de prueba
    ...
    // Función para navegar a la vista con parámetros
    const navegarAVista = () => {
        ...
        <Card className="mb-6 w-full">
            ...
            <CardContent>
                <div className="space-y-4">
                    {/* Campos de entrada sin labels, solo placeholders */}
...
export default function PaginaPruebas() {
    return (
        <div className="container mx-auto space-y-6 p-6">
            ...
            {/* Vista específica para dashboard del embajador */}
            <ComponenteVistaEmbajador />

            {/* Vista específica para registro de paciente como embajador */}
